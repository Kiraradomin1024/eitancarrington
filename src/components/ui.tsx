  ...
  return (
    <button
      ...
      className={cn(
        ...
        variant === "primary" &&
          "bg-foreground text-background hover:opacity-90 shadow-sm hover:shadow-[0_0_22px_var(--accent-glow)]",
        variant === "ghost" &&
          "text-foreground hover:bg-accent-soft border border-border hover:border-accent/50 hover:shadow-[0_0_18px_var(--accent-glow)]",
        variant === "danger" &&
    ...
    <Link
      ...
      className={cn(
        ...
        variant === "ghost" &&
          "text-foreground hover:bg-accent-soft border border-border hover:border-accent/50 hover:shadow-[0_0_18px_var(--accent-glow)]",
        variant === "gradient" &&
          "text-white bg-gradient-to-r from-accent via-accent-2 to-accent-3 btn-gradient",
        className
      )}
    >
      {children}
