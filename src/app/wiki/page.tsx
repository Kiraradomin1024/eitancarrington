          ...
          {npcs.map((n) => (
            ...
            >
              ...
              <div className="flex gap-4 pointer-events-none relative">
                <span
                  className={
                    "relative block w-16 h-16 shrink-0 rounded-full overflow-hidden border border-border " +
                ...
                >
                  {n.photo_url ? (
                    ...
                    <span className="w-full h-full bg-surface-2 flex items-center justify-center font-serif text-accent text-2xl">
                      {n.name[0]}
                    </span>
                  )}
                </span>
